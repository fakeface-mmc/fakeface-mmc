...
if __name__ == '__main__':
    ...
    # load file lists of train, validation, test dataset
    ...
    # calculate the minimum number of batches for composing pairs of 'real' and 'generated' faces
    ...
    for epoch in range(num_iter // num_batch_t, FLAGS.epoch):
        ...
        for t_idx in range(0, num_batch_t):
            ...
            # load training data from filelist
            ...
            # concatenate 'real' and 'fake' images/labels
            ...
            # load validation data from filelist
            ...
            # calculate loss and accuracy for training and validation dataset
        ...
        for v_idx in range(0, val_idxs):
            ...
            # calculate loss and accuracy for validation dataset
